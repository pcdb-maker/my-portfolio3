...
const icons = [
  { Component: ClubIcon, initialX: 30, initialY: 70, size: 50 },
  { Component: ClubIcon, initialX: 15, initialY: 20, size: 150 },
  { Component: ClubIcon, initialX: 70, initialY: 70, size: 200 },
  { Component: DiamondIcon, initialX: 25, initialY: 95, size: 25 },
  { Component: DiamondIcon, initialX: 80, initialY: 20, size: 65 },
  { Component: DiamondIcon, initialX: 5, initialY: 50, size: 100 },
  { Component: CircleIcon, initialX: 90, initialY: 60, size: 100 },
];
